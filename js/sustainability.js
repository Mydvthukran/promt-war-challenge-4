  ...
  function renderSustainabilityView() {
    ...
    container.innerHTML = `
      <div class="welcome-banner" style="background:linear-gradient(135deg,rgba(16,185,129,0.1),rgba(0,212,170,0.1));border-color:rgba(16,185,129,0.15)">
        <div class="welcome-title">🌱 Sustainability Dashboard</div>
        ...
        <div class="dashboard-grid grid-cols-3">
          ...
          <div class="card">
            <div class="stat-widget">
              ...
              <span class="stat-change ${data.foodWaste < 10 ? 'positive' : 'negative'}">${data.foodWaste < 10 ? '✅ Below target' : '⚠️ Above target'}</span>
            </div>
          </div>
        </div>
      ...
      <div class="dashboard-grid grid-cols-2">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="metric-row">
              <div class="metric-label">🗑️ Waste Generated</div>
              <div class="metric-value">${(data.wasteGenerated / 1000).toFixed(1)}t</div>
            </div>
            <div class="metric-row">
              <div class="metric-label">♻️ Recycled / Composted</div>
            ...
            <div class="metric-row">
              <div class="metric-label">☀️ From Renewables</div>
        ...
        <div style="display:flex;flex-direction:column;gap:var(--space-xl)">
          <div class="ai-card">
            <div class="ai-card-label">🧠 AI Sustainability Insight</div>
          ...
          <div class="ai-card">
            <div class="ai-card-label">🧠 AI Green Engagement</div>
          ...
          <div class="card card-accent-teal">
            <div class="card-header">
              <div class="card-title">🏆 Green Fan Leaderboard</div>
            </div>
            <div class="card-body">
              ${['🥇 Section 214 — 94% green transport', '🥈 Section 108 — 91% green transport', '🥉 Section 302 — 88% green transport', '4. Section 415 — 85% green transport', '5. Section 120 — 82% green transport'].map(item => `
