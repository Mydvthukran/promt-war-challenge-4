      ...
      <div class="dashboard-grid grid-cols-2-1" style="margin-bottom:var(--space-xl)">
        <div class="dashboard-grid grid-cols-3">
          ...
          <div class="card card-accent-blue">
            <div class="stat-widget">
              <div class="stat-icon blue"><!-- @license lucide-static v1.23.0 - ISC --><svg  class="lucide lucide-droplet"  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <path d="M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-4-6.5c-.5 2.5-2 4.9-4 6.5C6 11.1 5 13 5 15a7 7 0 0 0 7 7z" /></svg></div>
          ...
          <div class="card">
            <div class="stat-widget">
              <div class="stat-icon orange"><!-- @license lucide-static v1.23.0 - ISC --><svg  class="lucide lucide-utensils"  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2" />  <path d="M7 2v20" />  <path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7" /></svg></div>
              <div class="stat-value">${data.foodWaste.toFixed(1)}%</div>
              <div class="stat-label">Food Waste Rate</div>
              <span class="stat-change ${data.foodWaste < 10 ? 'positive' : 'negative'}">${data.foodWaste < 10 ? '<!-- @license lucide-static v1.23.0 - ISC --><svg  class="lucide lucide-check-circle"  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round" style="width:12px;height:12px;display:inline-block;vertical-align:text-bottom">  <path d="M21.801 10A10 10 0 1 1 17 3.335" />  <path d="m9 11 3 3L22 4" /></svg> Below target' : '<!-- @license lucide-static v1.23.0 - ISC --><svg  class="lucide lucide-alert-triangle"  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round" style="width:12px;height:12px;display:inline-block;vertical-align:text-bottom">  <path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3" />  <path d="M12 9v4" />  <path d="M12 17h.01" /></svg> Above target'}</span>
            </div>
          </div>
        </div>
